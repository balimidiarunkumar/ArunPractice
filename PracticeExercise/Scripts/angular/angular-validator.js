        ...
        return {
            ...
            link: function(scope, element, attrs, fn) {
                    ...
                    if (scopeElementModel.$dirty || (scope[element.form.name] && scope[element.form.name].submitted)) {
                        ...
                        if (scopeElementModel.$error.required) {
                            ...
                            if ("required-message" in element.attributes) {
                                if (element.attributes['required-message'].value) {
                        ...
                        else if (scopeElementModel.$error.pattern) {
                            // If there is a custom validation message add it
                            if ("pattern-message" in element.attributes) {
                                angular.element(element).after(generateErrorMessage(element.attributes['pattern-message'].value));
                            }
                            ...
                            if ("invalid-message" in element.attributes) {
                                if (element.attributes['invalid-message'].value) {
                ...
                function generateErrorMessage(messageText) {
                    ...
                    return "<label style='padding-top:5px;margin-bottom:-15px;' class='help-block has-error validationMessage'>" + scope.$eval(messageText) + "</label>";
                }
